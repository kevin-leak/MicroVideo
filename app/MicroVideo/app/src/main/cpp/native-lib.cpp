...
Java_com_crabglory_microvideo_micro_face_FaceTrack_native_1create(JNIEnv *env, jobject thiz,
...
Java_com_crabglory_microvideo_micro_face_FaceTrack_native_1start(JNIEnv *env, jobject thiz, jlong self) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crabglory_microvideo_micro_face_FaceTrack_native_1stop(JNIEnv *env, jobject thiz, jlong self) {
...
Java_com_crabglory_microvideo_micro_face_FaceTrack_native_1detector(JNIEnv *env, jobject thiz, jlong self,
    ...
    int ret = rects.size();
    if (ret) {
        jclass clazz = env->FindClass("com/crabglory/microvideo/micro/face/Face");
